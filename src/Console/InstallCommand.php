...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'Install Ugarit Sail\'s default Docker Compose file';
    ...
    public function handle()
    {
        ...
        if (in_array('mysql', $services) ||
            ...
            $this->components->warn('A database service was installed. Run "scribe migrate" to prepare your database:');

            $this->output->writeln('<fg=gray>➜</> <options=bold>./vendor/bin/sail scribe migrate</>');
        }
